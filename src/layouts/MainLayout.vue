          ...
          <q-card-section>
            ...
            >
              ...
              <q-carousel-slide :name="2" class="column no-wrap flex-center">
                <p><img src='/images/help_step2.png' srcset='/images/help_step2.png 1x, /images/help_step2@2x.png 2x' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step2_mobile") : t("getStartedText.step2") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="3" class="column no-wrap flex-center">
                <p v-if="!cardEditorStore.getIsMobileDevice"><img src='/images/help_step3_.gif' style='max-width:100%;max-height:200px;'></p>
                <p v-if="cardEditorStore.getIsMobileDevice"><img src='/images/help_step3@2x.png' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step3_mobile") : t("getStartedText.step3") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="4" class="column no-wrap flex-center">
                <p><img src='/images/help_step4@2x.png' style='max-width:100%;max-height:200px'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step4_mobile") : t("getStartedText.step4") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="5" class="column no-wrap flex-center">
                <p><img src='/images/help_step5.png' srcset='/images/help_step5.png 1x, /images/help_step5@2x.png 2x' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step5_mobile") : t("getStartedText.step5") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="6" class="column no-wrap flex-center">
                <p><img src='/images/help_step6.png' srcset='/images/help_step6.png 1x, /images/help_step6@2x.png 2x' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step6_mobile") : t("getStartedText.step6") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="7" class="column no-wrap flex-center">
                <p><img src='/images/help_step7.png' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step7_mobile") : t("getStartedText.step7") }}
                </div>
              </q-carousel-slide>
              <q-carousel-slide :name="8" class="column no-wrap flex-center">
                <p><img src='/images/help_step8.png' style='max-width:100%;max-height:200px;'></p>
                <div class="q-mt-md text-center beausiteLight text-body1">
                  {{ cardEditorStore.getIsMobileDevice ? t("getStartedText.step8_mobile") : t("getStartedText.step8") }}
                </div>
              </q-carousel-slide>
            </q-carousel>
          </q-card-section>
