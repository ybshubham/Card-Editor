export default {
  "en-US": {
    ...
    imgActionLabels: {
      ...
      uploadImgText: "Select Photo",
      dropImgText: "Drop Photo",
      editImgText: "Edit Crop",
      imgDragText: "Drag the image onto the card designer.",
    },
    btnLabels: {
      submit: "Submit",
      cancel: "cancel",
    ...
    modalText: {
      confirmModal: {
        ...
        content:
          "Please double-check that your design is exactly how you'd like it to be. Once you click proceed, your card will be saved and you will be redirected away from Editor.",
      },
      editChangeModal: {
        title: "Actions",
        editLabel: "Crop",
  ...
  "fr-CA": {
    ...
    apiResponseText: {
      ...
      uploadErrorText: "Échec du téléchargement",
    },
    modalText: {
      confirmModal: {
  ...
  "sv-SE": {
    ...
    apiResponseText: {
      ...
      uploadErrorText: "Uppladdningen misslyckades",
    },
    modalText: {
      confirmModal: {
